...
RUN tlmgr option repository https://mirror.ctan.org/systems/texlive/tlnet \
  ...
  && tlmgr install babel-german biblatex biblatex-apa booktabs caption csquotes etoolbox fancyvrb fontspec hyphen-german latexindent latexmk lineno minted newfloat parskip ragged2e setspace sidecap titlesec upquote \
  && tlmgr update --all
