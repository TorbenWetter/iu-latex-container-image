...
RUN apt-get update \
  ...
  && apt-get install -y --no-install-recommends build-essential cpanminus libbz2-dev libc6-dev libdatetime-perl libexpat1-dev libffi-dev libgdbm-dev liblzma-dev libncurses5-dev libncursesw5-dev libreadline-dev libsqlite3-dev libssl-dev libxml2 libxml2-dev libxslt1.1 libxslt1-dev llvm locales make python3-pygments tk-dev ttf-mscorefonts-installer zlib1g-dev \
